...
pub struct SyncManager<T: BeaconChainTypes> {
    ...
    /// Handles single and multiple block lookups.
    block_lookup: BlockLookup<T>,
...
pub fn spawn<T: BeaconChainTypes>(
    ...
    let mut sync_manager = SyncManager {
        ...
        block_lookup: BlockLookup::new(beacon_chain.clone(), beacon_processor_send.clone(), log.clone()),
